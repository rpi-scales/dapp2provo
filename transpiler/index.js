...
const driver = neo4j.driver("bolt://localhost:7687", neo4j.auth.basic("neo4j", "neo4j123"));  //Or whatever your neo4j credentials are
...
function create_rels(options){
  // transactions+=`${options.label} ${options.name} ${options.relationship} ${options.label2} ${options.value}`
